            ...
            <div className="space-y-6">
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 p-6 rounded-[32px]">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <div className="flex-1 h-14 bg-white/10 border border-white/20 rounded-2xl px-5 flex items-center overflow-hidden">
                  ...
                  <Button 
                    ...
                    className="h-14 px-8 rounded-2xl bg-white text-blue-800 hover:bg-blue-50 font-black text-[10px] uppercase tracking-widest transition-all active:scale-95 shrink-0"
                  >
